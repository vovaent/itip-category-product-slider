...
function init() {
  const elsProduct = document.getElementsByClassName('product type-product');
  ...
  const itipCategoryProductSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper.itip-cps', {
